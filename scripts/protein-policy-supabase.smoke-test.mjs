...
assert(resolveProteinFactorGPerKg('weight_loss', 'resistance', custom) === 1.85, 'Runtime RT factor not applied');
assert(resolveProteinFactorGPerKg('maintenance', 'cardio', custom) === 1.35, 'Runtime no-RT factor not applied');
